      ...
      <div style={{ 
        ...
        >
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '2rem' }}>
              {[
                  { label: 'Direct Inquiry', value: 'bharathbalu401@gmail.com', icon: <Mail size={18} /> },
                  { label: 'Voice / WhatsApp', value: '+91 6305443592', icon: <Phone size={18} /> },
                  { label: 'Current Base', value: 'India', icon: <MapPin size={18} /> }
              ].map((item, i) => (
