    ...
    >
      <div style={{ 
        ...
        <div style={{ flex: 1 }}>
            ...
            <div style={{ display: 'flex', gap: '1.2rem' }}>
                {[
                    { icon: <Github size={18} />, url: "https://github.com/BharathReddyBalu", label: "GitHub" },
                    { icon: <Linkedin size={18} />, url: "https://linkedin.com/in/bharathreddy3398", label: "LinkedIn" }
                ].map((social, idx) => (
                    <motion.a
                        key={idx}
                        href={social.url}
        ...
        <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                <a href="mailto:bharathbalu401@gmail.com" style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', color: theme.text, opacity: 0.6, textDecoration: 'none', fontSize: '0.9rem' }}>
                    <Mail size={15} color={theme.accent} /> 
                    <span>bharathbalu401@gmail.com</span>
                </a>
                <a href="tel:+916305443592" style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', color: theme.text, opacity: 0.6, textDecoration: 'none', fontSize: '0.9rem' }}>
                    <Phone size={15} color={theme.accent} />
                    <span>+91 6305443592</span>
                </a>
            </div>
        </div>
      ...
      <div style={{ 
        ...
        <p style={{ opacity: 0.4, fontSize: '0.8rem', letterSpacing: '0.05em' }}>
            © {year} Developed by <span style={{ fontWeight: 700, color: theme.text }}>Balu Bharath Kumar Reddy</span>. 
        </p>
      </div>
    </footer>
  );
